...
function getSkillIcon(slug) {
  if (!slug) return "";

  if (slug === "github") {
    return `
      <svg class="skill-svg-icon" viewBox="0 0 128 128" fill="currentColor">
        <g>
